...
{
    /// <summary>
    /// Static class that handles automatic component configuration.
    /// </summary>
    public static class ComponentConfigurator
    {
        /// <summary>
        /// Applies component configuration on a MonoBehaviour based on [ConfigureComponent]
        /// </summary>
        /// <param name="component">MonoBehaviour to process</param>
        /// <returns>Number of properties configured</returns>
