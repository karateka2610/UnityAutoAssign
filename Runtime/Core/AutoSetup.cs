...
{
    /// <summary>
    /// Static class that handles automatic GameObject configuration using reflection.
    /// </summary>
    public static class AutoSetup
    {
        /// <summary>
        /// Applies automatic configuration to a MonoBehaviour based on the [AutoSetup] attribute
        /// </summary>
        /// <param name="component">MonoBehaviour to configure</param>
        /// <returns>True if any configuration was applied</returns>
